...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "James Adewara — I Build & Ship Full-Stack Products for Founders" },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "James Adewara — Fullstack Developer for Founders",
      },
      {
        property: "og:description",
        content:
          "I build and ship full-stack MVPs for early-stage founders. React, Next.js, FastAPI, Django, AWS.",
      },
    ],
  }),
  component: HomePage,
  ...
  return (
    <>
      ...
      <section className="container-tight relative pt-10 md:pt-20 pb-24 md:pb-32">
        ...
        >
          I Build & Ship{" "}
          <span className="text-gradient-brand">Full-Stack Products</span>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-5 max-w-xl text-muted-foreground text-pretty">
              Open for MVP projects and freelance engagements. Let's talk about what you're
              building.
            </p>
