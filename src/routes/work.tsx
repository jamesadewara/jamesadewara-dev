...
export const Route = createFileRoute("/work")({
  head: () => ({
    meta: [
      { title: "Work — James Adewara" },
      {
        name: "description",
        content:
          "Selected case studies: Ventunna Bespoke Fashion (UK e-commerce) and Dwyzmax Electronics (Nigerian e-commerce). Production fullstack builds.",
      },
      { property: "og:title", content: "Work — James Adewara" },
      {
        property: "og:description",
        content:
          "Production fullstack case studies — UK and Nigerian e-commerce platforms shipped end-to-end.",
      },
    ],
  }),
  component: WorkPage,
